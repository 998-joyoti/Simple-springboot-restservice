...
import com.example.firstapplication.SpringBootRestService.service.LibraryService;
...
//    public List<Library> getBookById(@RequestParam(value="page", defaultValue = "0") int page, @RequestParam(value="limit", defaultValue = "2") int limit)
//    {
//        return libraryService.getAllBooks(page, limit);
//
//    }
